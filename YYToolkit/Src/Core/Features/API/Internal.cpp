...
#if _DEBUG
	Utils::Logging::Message(CLR_GOLD, "YYToolkit %s (Debug) by @archie_uwu, forked by sam-k0", YYSDK_VERSION);
#else
	Utils::Logging::Message(CLR_LIGHTBLUE, "YYToolkit by @archie_uwu, forked by sam-k0", YYSDK_VERSION);
#endif
